...
const emailregistroPro = async (datos) => {
  try {
    ...
    const { nombres, email, token, rut } = datos;
    ...
    const info = await transporter.sendMail({
      ...
      to: email,
      subject: 'Comprueba tu cuenta de PROFESIONAL en Cimiento Clínico',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h1 style="color: #077070; margin-bottom: 20px;">¡Hola ${nombres}!</h1>
          <h2 style="color: #51B6B6; margin-bottom: 20px;">Comprueba tu cuenta de Profesional en Cimiento Clínico</h2>
          ...
          <p style="text-align: center;">
            <a href="${process.env.FRONTEND}/confirmar-pro/${token}" style="display: inline-block; background-color: #077070; color: #fff; text-decoration: none; padding: 10px 20px; font-size: 16px; border-radius: 5px;">
              Comprobar tu cuenta
            </a>
          </p>
...
export default emailregistroPro;